...
export const Header = () => {
    ...
    const filterOptions = (listOfPizzas:any, selectedPizzafromSearchBar:any ) => { 
        ...
        console.log("inside filterOptions listOfPizzas", listOfPizzas);
    ...
    //     listOfPizzas = fuse.search(searchQuery).map((result:any) => result);
    //     console.log("fuse search response is ", listOfPizzas);
    // }
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                <Avatar alt="S" src="../static/images/avatar/shubham.jpg" />
                            </IconButton>
                        </Tooltip>
                        <Menu
                            sx={{ mt: '45px' }}
